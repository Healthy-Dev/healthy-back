...
<mjml>
  ...
  <mj-body background-color="#041a2f">
    ...
    <mj-section padding-bottom="20px" padding-top="10px" background-color="#03111f">
      <mj-column>
        <mj-text align="center" padding="10px 25px" font-size="20px" color="#FFFF"><strong>Hola {{nameOrUsername}}!</strong></mj-text>
        <mj-text align="center" font-size="18px" font-family="Arial" color="#FFFF">Muchas gracias por registrarte en Healthy Dev<br/> Para resetear tu contraseña haz click en el siguiente boton</mj-text>
        <mj-button background-color="#f4dd27" color="#FFFFFF" href="{{resetPasswordLink}}" font-family="Arial, sans-serif" padding="20px 0 0 0" font-weight="bold" font-size="16px">Resetear contraseña</mj-button>
        <mj-text align="center" color="#FFFF" font-size="14px" font-family="Arial, sans-serif" padding-top="20px">Si no reconoces este mail, haz <mj-button color="#FFFFFF" href="{{deleteLink}}" font-family="Arial, sans-serif" font-weight="bold" font-size="14px">click aquí</mj-button></mj-text>
        <mj-text align="center" color="#FFFF" font-size="14px" font-family="Arial, sans-serif" padding-top="40px">Healthy Dev es un proyecto de la comunidad FrontEnd Cafe
        </mj-text>
      </mj-column>
    </mj-section>
